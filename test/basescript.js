//TODO problem with Get all Params..
// Email not a function-> The error of all
...
const data1 = {email: "example@example.com", password: "aA3", remail: "example@example.com", rpassword: "aA3", name:"examp"};
fetch('http://localhost:3001/register', {
    method: 'POST', // or 'PUT'
    headers: {
        'Content-Type': 'application/json',
...
const data10 = {username: "taldanai", password: "fiuwea"};
fetch('http://localhost:3001/register', {
    method: 'POST', // or 'PUT'
    headers: {
        'Content-Type': 'application/json',
...
const usernames = [];
fetch('http://localhost:3001/getallusernames', {
    method: 'POST', // or 'PUT'
    headers: {
        'Content-Type': 'application/json',
    },
