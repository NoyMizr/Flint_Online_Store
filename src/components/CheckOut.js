...
const CheckOut = (props) => {
    ...
    const onFieldsChanged = (price) => {
        //when price is the total calc'
        fetch(`http://localhost:3001/checkout/${price}`, {
            method: 'POST', // or 'PUT'
            headers: {
    ...
    return (
        <Router>
            ...
            <br></br>
            <div className="log">
                <header> <Title style={{color: 'BLACK'}} level={2}>Check Out</Title>
                    <Form
                        form={form}
                        layout="vertical"
                    ...
                    >
                        ...
                        >
                            <Input type="text" name="lastName" id="lastName" style={{}} placeholder="" />
                        </Form.Item>
                        ...
                        >
                            <Input type="text" name="address" id="address" style={{}} placeholder="" />
                        </Form.Item>
                        ...
                        >
                            <Input type="text" name="zipCode" id="zipCode" style={{}} placeholder="" />
                        </Form.Item>
                        ...
                        >
                            <Input type="text"  id="number" style={{}} placeholder="" />
                        </Form.Item>
